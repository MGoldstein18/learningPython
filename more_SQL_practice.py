...
# The users database contains user information, the watch_history contains information about each watching event and the payments database contains info about payments
